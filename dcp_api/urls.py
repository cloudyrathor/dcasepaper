...
urlpatterns = [
    ...
    path('patient-medical-profile/<int:pk>/',RUD_PatientMedProfile.as_view(), name ='patient-medical-profile' ),

    path('doctor-profile-list/',Post_Doctors.as_view(), name='doctor-profile-list'),
    path('doctor-profile/<int:pk>/',RUD_Doctors.as_view(), name ='patient-profile' ),

    path('treatment-new/',Post_Treatment.as_view(), name='treatment-new'),
    path('treatment/<int:pk>/',RUD_Treatment.as_view(), name ='treatment'),

#In_Process
    path('patient-treatment-history/<int:p_id>/',Post_Patient_Treatment_History.as_view(), name='patient-treatment-history'),
    path('patient-treatment-history/<int:pk>/',RUD_Patient_Treatment_History.as_view(), name ='patient-treatment-history'),
